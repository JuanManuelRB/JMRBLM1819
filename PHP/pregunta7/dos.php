...
<?php
    ...
    $registros = mysqli_query($conection, 'SELECT * 
    FROM alumnos 
    WHERE mail = "' . $email .'"') or die("Error en: ".mysqli_error($conection));

    if($reg = mysqli_fetch_array($registros)){
        echo '<table class="table table-dark">';
        echo '<tr><th>Codigo</th><th>Nombre</th><th>Email</th><th>Email</th>';
            echo '<tr>';
        ...
        echo "<p>No existe ningun usuario con ese Email</p>";
    }
